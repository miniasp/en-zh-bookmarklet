...
* 針對 ``*.microsoft.com`` 與 ``*.google.com`` 這兩個網站自動進行語系切換，如果你想支援其他語系，請自行 fork 後修改，也歡迎多多利用 pull request 將您的修改合併回來。
* 針對 `getbootstrap.com` 網站，可與 `v3.bootcss.com` 網站進行切換 (簡體中文文件) (可搭配 **新同文堂** 進行繁簡轉換)
